...
export async function sendMagicLinkEmail(email: string, code: string) {
  try {
    ...
    await transporter.sendMail({
      from: `H-Town Combat 67 <${process.env.MAIL_FROM || 'zirkumflex666@gmail.com'}>`,
      to: email,
      subject: 'Your H-Town Combat 67 Magic Link Code',
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <h2 style="color: #06b6d4;">H-Town Combat 67</h2>
          ...
          <a href="${loginUrl}" style="display: inline-block; background: #06b6d4; color: black; padding: 12px 24px; border-radius: 6px; text-decoration: none; font-weight: bold; margin: 10px 0;">Login to H-Town Combat 67</a>
          ...
          <p style="font-size: 12px; color: #9ca3af;">© 2026 H-Town Combat 67. All rights reserved.</p>
        </div>
      `,
      text: `Your H-Town Combat 67 magic link code is: ${code}\n\nThis code expires in 10 minutes.\n\nIf you didn't request this code, you can safely ignore this email.`,
    })
